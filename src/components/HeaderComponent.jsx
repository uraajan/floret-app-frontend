            ...
            <header>
                <nav className="navbar navbar-expand-md navbar-dark bg-dark">
                    ...
                    <ul className="navbar-nav navbar-collapse justify-content-end">
                        ...
                        {AuthenticationService.isUserLoggedIn() && <li><Link className="nav-link" to="/cart">Cart</Link></li>}
                        {AuthenticationService.isUserLoggedIn() && <li><Link className="nav-link" to="/orders">Orders</Link></li>}
                        {AuthenticationService.isUserLoggedIn() && <li><Link className="nav-link" to="/profile">Profile</Link></li>}
